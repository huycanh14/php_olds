...
if (isset($_SESSION['user'])){
	header('location: user/monhoc.php');
	exit;
}
?>
<!DOCTYPE html>
...
<head>
	...
	<div id="noidung" align="center">
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="monhoc_edit.php?mamonhoc=<?php echo $monhoc['mamonhoc'] ;?>">Sửa</a></td>
					<td><a onclick="return checkDelete();" href="monhoc_delete.php?mamonhoc=<?php echo $monhoc['mamonhoc'];?>">Xóa</a></td>
					<?php $stt++ ;?>
				</tr>
				<?php
					endforeach;
		...
		<br>
		<form action="" method="post">
			<button type="button"><a href="monhoc_add.php" style="text-decoration: none;text-transform: uppercase; color: #000;">Thêm mới</a></button>
