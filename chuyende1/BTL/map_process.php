...
$mDescr	 	= filter_var($_POST["descr"], FILTER_SANITIZE_STRING);


$results = $mysqli->query("INSERT INTO food (name, address, lat, lon, type, descr) VALUES ('$mName','$mAddress',$mLat, $mLng,'$mType','$mDescr')");
if (!$results) {  
